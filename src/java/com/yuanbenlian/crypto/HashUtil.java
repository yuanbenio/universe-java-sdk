 ...
 */
package com.yuanbenlian.crypto;

import com.yuanbenlian.crypto.cryptohash.Keccak256;
import com.yuanbenlian.crypto.cryptohash.Keccak512;
import com.yuanbenlian.util.RLP;
import com.yuanbenlian.util.Utils;
...
import static com.yuanbenlian.util.ByteUtil.EMPTY_BYTE_ARRAY;
...
public class HashUtil {
    ...
    private static final Provider CRYPTO_PROVIDER = Security.getProvider("SC");
