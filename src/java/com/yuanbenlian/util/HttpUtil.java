...
public class HttpUtil {
     ...
     */
    public static String sendGet(String url) throws InvalidException {
        String result = "";
        ...
        try {
            ...
            throw new InvalidException("http get request error", e);
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, String param) throws InvalidException {
