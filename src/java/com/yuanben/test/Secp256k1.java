...
import com.yuanben.crypto.HashUtil;
import com.yuanben.crypto.HexUtil;
import com.yuanben.crypto.cryptohash.Keccak256;
import com.yuanben.crypto.jce.ECAlgorithmParameters;
import com.yuanben.crypto.jce.ECKeyPairGenerator;
import com.yuanben.crypto.jce.ECSignatureFactory;
import com.yuanben.model.License;
...
//        System.out.println(ECKeyGenerator.VerifySignature(pubKey,signatureMsg,Hex.decode(contentHash)));
        test8();
    }
